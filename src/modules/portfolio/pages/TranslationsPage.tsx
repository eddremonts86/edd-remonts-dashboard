            ...
            <thead>
              <tr className="border-b border-border bg-muted/50">
                ...
                {LOCALES.map((locale) => (
                  <th
                    key={locale}
                    className="px-4 py-3 text-left font-medium text-muted-foreground uppercase"
                  >
                    {locale}
                  </th>
                ))}
