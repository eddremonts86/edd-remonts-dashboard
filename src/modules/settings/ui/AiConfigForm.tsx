                ...
                {[
                  {
                    ...
                    title: 'MiniMax',
                    description:
                      'Cloud-based LLM API from MiniMax offering powerful text generation at competitive pricing.',
                    Icon: MinimaxIcon,
                  },
                  {
                    id: 'llama-cpp',
                  ...
                  const status = providerStatuses?.filter(Boolean).find((s) => s.id === provider.id)
