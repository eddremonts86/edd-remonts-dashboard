  ...
  const impactCards: ImpactCard[] = [
    {
      ...
      whatChanged: t('stats.impactCards.payload.whatChanged', 'Slashed initial bundle size by 94% through Vite monorepo partitions and code-splitting.'),
      whatItImproved: t('stats.impactCards.payload.whatItImproved', 'Enabled distributed teams to release features independently, and improved LCP to 1.4s.'),
    ...
    },
    {
      ...
      whatChanged: t('stats.impactCards.shipping.whatChanged', 'Coordinated design-system contracts, component standards, and modular versioning guidelines.'),
      whatItImproved: t('stats.impactCards.shipping.whatItImproved', 'Accelerated overall feature-delivery speeds by 30% across 20+ frontend engineers.'),
      proofLink: 'https://github.com/eddremonts86/edd-remonts-dashboard',
      Icon: ShieldCheck,
    },
    {
      ...
      whatChanged: t('stats.impactCards.latency.whatChanged', 'Restructured site-builder rendering architecture to isolate mutation cycles to individual cells.'),
      whatItImproved: t('stats.impactCards.latency.whatItImproved', 'Reduced perceived UI latency for real-time edits and secured 100% Core Web Vitals.'),
      proofLink: 'https://github.com/eddremonts86/edd-remonts-dashboard',
      Icon: Zap,
    },
    {
      ...
      whatChanged: t('stats.impactCards.throughput.whatChanged', 'Optimized real-time logistics socket rendering with virtualized list memoization queues.'),
      whatItImproved: t('stats.impactCards.throughput.whatItImproved', 'Handled 500+ updates/sec with zero lag, and reduced infrastructure query costs by 60%.'),
      proofLink: 'https://github.com/eddremonts86/edd-remonts-dashboard',
      Icon: Activity,
    },
  ]
      ...
      <div className="container relative z-10 mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <h2 className="font-display text-4xl font-light tracking-tight md:text-5xl lg:text-7xl text-foreground leading-tight">
            ...
            <span className="font-serif italic text-primary">{t('stats.businessImpact.titleAccent', 'Business Outcomes')}</span>
          </h2>
          <p className="mt-5 max-w-xl text-sm leading-relaxed text-foreground/60 md:text-base font-light font-display">
            {t('stats.businessImpact.subtitle', 'Technical excellence is relevant when it drives business value. Here is the concrete, verifiable operational and product impact delivered across enterprise-scale applications.')}
          </p>
        </m.div>
