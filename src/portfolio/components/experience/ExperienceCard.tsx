...
export const ExperienceCard = ({ exp, index }: ExperienceCardProps) => {
  ...
  return (
    <m.div
      ...
      className="group relative -mx-4 flex cursor-default flex-col justify-between px-4 py-10 transition-colors duration-500 hover:bg-foreground/[0.04] md:flex-row"
    >
      <div className="mb-4 flex w-full flex-col md:mb-0 md:w-1/3 md:pr-8">
        ...
        <h4 className="mb-1 text-lg font-semibold tracking-tight md:text-xl">{exp.company}</h4>
      ...
      <div className="flex w-full flex-col justify-center md:w-2/3">
        <div className="mb-3 flex items-start justify-between gap-4">
          ...
          <ArrowUpRight aria-hidden="true" className="hidden h-5 w-5 shrink-0 -translate-x-2 transform text-primary opacity-0 transition-all duration-500 group-hover:-translate-y-1 group-hover:translate-x-0 group-hover:opacity-100 md:block" />
        </div>
